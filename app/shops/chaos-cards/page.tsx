export default function ChaosCardsPage() {
  return (
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <section className="grid gap-6 lg:grid-cols-[1.5fr_0.8fr]">
          <div className="rounded-[32px] border border-white/10 bg-white/5 p-8">
            ...
            <h1 className="mt-4 text-4xl font-semibold">Chaos Cards</h1>
            <p className="mt-4 max-w-3xl text-white/65">
              Chaos Cards is a well-known UK trading card retailer with strong
              coverage across sealed products, accessories, and mainstream TCG
              releases. It is a solid starting point for collectors looking for
              reliable stock and broad category coverage.
            </p>
            ...
            <div className="mt-8 grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
                ...
                <p className="mt-2 font-medium">Pokémon and TCGs</p>
              </div>
            </div>
          </div>
            ...
            <div className="mt-6 space-y-4">
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
                <div className="flex items-center justify-between">
                  ...
                  <p className="font-semibold text-cyan-200">8.9 / 10</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
                <div className="flex items-center justify-between">
                  ...
                  <p className="font-semibold text-cyan-200">8.2 / 10</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
                <div className="flex items-center justify-between">
                  ...
                  <p className="font-semibold text-cyan-200">9.1 / 10</p>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
                <div className="flex items-center justify-between">
                  ...
                  <p className="font-semibold text-cyan-200">8.4 / 10</p>
                </div>
              </div>
            </div>
        ...
        <section className="mt-8 grid gap-6 lg:grid-cols-2">
          <div className="rounded-[28px] border border-white/10 bg-white/5 p-6">
            ...
            <ul className="mt-5 space-y-3 text-sm leading-6 text-white/70">
              <li>• Broad range of mainstream sealed products</li>
              <li>• Reliable place to browse current releases</li>
              <li>• Good entry point for newer collectors</li>
              <li>• Strong category depth across popular games</li>
            </ul>
          </div>
          ...
          <div className="rounded-[28px] border border-white/10 bg-white/5 p-6">
            ...
            <ul className="mt-5 space-y-3 text-sm leading-6 text-white/70">
              <li>• Hot products can sell out quickly</li>
              <li>• Not always the absolute lowest price</li>
              <li>• Some collector items may be better elsewhere</li>
              <li>• Best used with price comparison over time</li>
            </ul>
          </div>
        </section>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
              ...
              <h3 className="mt-3 text-lg font-medium">
                Strong sealed Pokémon selection
              </h3>
            </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
              ...
              <h3 className="mt-3 text-lg font-medium">
                Strong starting point for UK buyers
              </h3>
            </div>
          </div>
        </section>
